...
(function (global) {
  ...
  SL = {
    ...
    mcssfive: function () {
      ...
      style.innerHTML += ".carousel-control {mix-blend-mode:lighten; opacity:.45 !important; -ms-mix-blend-mode:lighten; -moz-mix-blend-mode:lighten; }    \n";
      ...
      style.innerHTML += "#bigfoot.banup {animation: 10s ease-in 0s 1 slideInFromBottom; }    \n";
      ...
      style.innerHTML += "._2BGlvm1kLFck9O2GFU4ylE {display:none !important;}   #bigbutton button._2BGlvm1kLFck9O2GFU4ylE {display:none !important;} #bigfoot button._24d6f3pjhfa71-59bfd2pl {display:none !important;}   \n";
      style.innerHTML += "._2ZGrkQkADN6UCnHD2zeyBV { cursor:default;  }  .carousel-inner>.item { display:block !important; }  ";

      style.innerHTML += '._2LrNf_NvtrBLjlIOAsdrUx.premierleague {cursor: default !important;}';
    ...
    banner: function () {
      ...
      banner.innerHTML += '<div class="KambiWidget-card-text-color KambiWidget-card-background-color KambiWidget-font"> <div id="root"> <div class="_2OxpQtsHRSTr2u_Ynb4ksS"> <div class="_3QZWmDp1baLHc7JHCjQQFJ KambiWidget-primary-color" style="background-color: currentcolor;"> <div class="_3ZNlUyZ8UEOla98u6xPPKX" style="background:url(https://sb.monetate.net/img/1/748/1249748.jpg); background-repeat: no-repeat; mix-blend-mode: multiply; background-size: cover;"></div></div><div class="_3ckHxuwM96lfZZnJgbsgH0" style="opacity: 1;"> <div class="_3tKoj0RObqZkwOpujMEGIN"> <div class="_3Ja5nsZNXVRSBY5FSetfAi"> <div class="_2LrNf_NvtrBLjlIOAsdrUx premierleague"> <div class="_1_MkP3PA1jHXnmX_bn5HQL" style="width:213px; height:90px; min-width:213px !important; max-width:213px;"><i class="kw-custom-logo-large-type" style="background:url(https://sb.monetate.net/img/1/748/1261961.png);"></i> <button class="_2BGlvm1kLFck9O2GFU4ylE"> <a data-slide="prev" href="#Carousel" class="left carousel-control"> <svg class="_2qHBrX_10eszn1kY7ZQlrc" width="22px" height="36px" viewBox="0 860 420 500" version="1.1" xmlns="http://www.w3.org/2000/svg"> <path id="arrowLeft" transform="scale(1, -1) translate(0, -1500)" d="M358.286 640q0-7.429-5.714-13.143l-224.571-224.571 224.571-224.571q5.714-5.714 5.714-13.143t-5.714-13.143l-28.571-28.571q-5.714-5.714-13.143-5.714t-13.143 5.714l-266.286 266.286q-5.714 5.714-5.714 13.143t5.714 13.143l266.286 266.286q5.714 5.714 13.143 5.714t13.143-5.714l28.571-28.571q5.714-5.714 5.714-13.143z"> </path> </svg> </a> </button> <button class="_24d6f3pjhfa71-59bfd2pl"> <a data-slide="next" href="#Carousel" class="right carousel-control"> <svg class="_2qHBrX_10eszn1kY7ZQlrc" width="22px" height="36px" viewBox="0 860 420 500" version="1.1" xmlns="http://www.w3.org/2000/svg"> <path id="arrowRight" transform="scale(1, -1) translate(0, -1500)" d="M358.286 640q0-7.429-5.714-13.143l-224.571-224.571 224.571-224.571q5.714-5.714 5.714-13.143t-5.714-13.143l-28.571-28.571q-5.714-5.714-13.143-5.714t-13.143 5.714l-266.286 266.286q-5.714 5.714-5.714 13.143t5.714 13.143l266.286 266.286q5.714 5.714 13.143 5.714t13.143-5.714l28.571-28.571q5.714-5.714 5.714-13.143z"> </path> </svg> </a> </button>        </div></div></div></div> ';
    ...
    tidyup: function () {
      ...
      if (document.querySelector('.kw-custom-logo-large-type') != undefined) {
      ...
      if (document.querySelector('#bigfoot') != null) {
