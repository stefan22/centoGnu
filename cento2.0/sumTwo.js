...
(function (global) {
  ...
  SL = {
        ...
        if (this.readyState == 4 && this.status == 200) {
          ...
          function runAgain() {
            ...
            if (document.body.className.indexOf("notloaded") != null) {
              ...
              //add loaded,fadein
              document.body.className = " loaded fadeout";
              return true;
    ...
    mcssthree: function () {
      ...
      var mainone = '._1_MkP3PA1jHXnmX_bn5HQL i {width:213px; max-width:213px !important;}  i.kw-custom-logo-large-type {margin-top:0em !important; opacity:1; height:90px;} #root ._1_MkP3PA1jHXnmX_bn5HQL {height:126px !important; }   #bigfoot a.carousel-control:hover { background-color:transparent; color:#020202; font-weight:bolder; outline: 0px solid #001216;  } ';
    ...
    mcssfive: function () {
      console.info('%c mcssfive \u221a', 'background:blue;color:white;');
      ...
      style.innerHTML += "._2LrNf_NvtrBLjlIOAsdrUx.premierleague {width:230px !important;} ";
      //each item -Ux
      style.innerHTML += "#bigfoot ._2LrNf_NvtrBLjlIOAsdrUx {margin-right:2em; float:left; width:365px;  }    \n";
      //item
      style.innerHTML += ".item {height:102px; margin:1.2em 0 1em; }    \n";
      
      style.innerHTML += "._3Ja5nsZNXVRSBY5FSetfAi ._2LrNf_NvtrBLjlIOAsdrUx {margin-right:3em !important; } ";
      ...
      style.innerHTML += "#bigfoot ._24d6f3pjhfa71-59bfd2pl { z-index: 1000;  height:55px !important; cursor:pointer !important; } #bigfoot ._2BGlvm1kLFck9O2GFU4ylE { height:55px !important; z-index:1000; cursor:pointer; background: #271e8c00 !important;}  \n";
    ...
    slider: function () {
      console.info('%c slider \u221a', 'background:blue;color:white;');
